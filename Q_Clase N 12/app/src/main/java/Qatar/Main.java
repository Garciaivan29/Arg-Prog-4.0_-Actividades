...
//CREATE TABLE departamento(id int NOT NULL AUTO_INCREMENT,
// nombre varchar(50) NOT NULL,
// presupuesto int NOT NULL,
// PRIMARY KEY (id) );

//CREATE TABLE empleado ()dni int NOT NULL,
// nombre varchar(50) NOT NULL,
...
//INSERT empleado VALUES (26711628, 'Daniela', 'Fernandez', 'Argentina', 1);
//INSERT empleado VALUES (28611762, 'Ergy', 'Erika', 'Mexicana', 2);
//INSERT empleado VALUES (27918293, 'Random', 'Random', 'Random', 3);

//5) Modificar la nacionalidad de algún empleado.

//UPDATE empleado SET nacionalidad='Mexicana' WHERE dni=26711628;
